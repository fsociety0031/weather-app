...
import ClimateChartNextDays from "./ClimateNextDaysChart";
...
export default function Card(data) {
  ...
  return (
    <div className="container">
      ...
      <div className="d-column flex-row mt-5 mb-5">
                ...
                <div className="col-md-6 d-flex flex-column justify-content-between">
                  <div className="d-flex d-row flex-row justify-content-around w-text mt-3">
                    <div className="text-start">
                      <h1 className="mt-3">{ data.formatted || city || dataCoords.results[0].components.state}</h1>
                      <p>{state || dataCoords.results[0].components.state_code}</p>
                    ...
                    <div className="text-end">
                      ...
                      <p className="text-end mt-4">Máx.: {temp && (Math.round(temp.daily[0].temp.max))}ºC Mín.: {temp && (Math.round(temp.daily[0].temp.min))}ºC</p>
                    </div>
                  </div>
                  <div className="box-condicoes">
                    { temp && temp.hourly && (
                      <ClimateChart data={dataHourly}/>
                    )}
                  </div>
                </div>
                  ...
                  <div className="box-previsao d-flex flex-column justify-content-between">
                    <div className="d-flex flex-row justify-content-start">
                      <div className="d-flex flex-column justify-content-center align-items-center  w-100">
                        ...
                        { temp && temp.hourly && (
                          <ClimateChartNextDays data={dataHourly} />
                        )}
                      </div>
                    </div>
                  </div>
